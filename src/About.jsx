...
export const About = () => {
  return (
    <div>
      <div className="container mt-md-5 mt-lg-5 mt-xl-5 ">
        <div className="row">
          <div className="col-md-6 mt-5 ">
            ...
            <div className='education-box px-md-3 px-lg-3 px-1'>
              <h5 className='font-bolder mt-md-3 mt-lg-3'>Education</h5>
              <p className='clg-ins mt-md-3 mt-lg-3'>2023-BCA,INDO AMERICAN <br /> College</p>
            </div>
            <div className='education-box px-md-3 px-lg-3 px-1 '>
              <h5 className='font-bolder mt-md-3 mt-lg-3'>Certification</h5>
              <p className='clg-ins mt-md-3 mt-lg-3'>2024-Full Stack Web development and Designing,Web D School</p>
            </div>
            </div>
          </div>
